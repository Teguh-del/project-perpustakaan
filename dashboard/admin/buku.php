  ...
  <main class="flex-1 p-6">
    ...
    <div class="mb-4 flex gap-2">
      <div class="relative flex-1">
        <input type="text" placeholder="Cari judul atau penulis..." class="w-full px-4 py-2 border rounded-lg pl-10">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          if ($result && $result->num_rows > 0):
            while ($buku = $result->fetch_assoc()):
              ...
              $warna_kategori = 'bg-blue-100 text-blue-800';
              if ($buku['kategori'] === 'novel') {
                  $warna_kategori = 'bg-purple-100 text-purple-800';
              }
          ?>
            <tr>
              <td class="px-6 py-4">
