...
<body class="min-h-screen">
  ...
  <section class="py-8">
    <div class="container mx-auto px-4">
      ...
      // Ambil buku publik + cover path + deskripsi
      $sql = "SELECT id, judul, penulis, cover_path, deskripsi FROM buku WHERE eksklusif_member = 0 AND jumlah_stok > 0 ORDER BY judul";
      ...
      <?php else: ?>
        <div class="empty-state">
          ...
          <h3 class="font-medium text-lg mb-1">Belum Ada Buku Tersedia</h3>
          <p>Admin sedang menyiapkan koleksi. Kunjungi lagi nanti!</p>
        </div>
      <?php endif; ?>
    </div>
  </section>
