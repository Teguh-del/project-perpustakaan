...
<body class="min-h-screen flex items-center justify-center p-4">
  ...
  <path d="M8 2.5C6 1 3.5 1 1.5 2v10c2-.9 4-.9 6 .5V2.5zM8 2.5c2-1.5 4.5-1.5 6-.5v10c-2-.9-4-.9-6 .5V2.5z"/>
    ...
    <h2 class="text-center text-gray-700 text-xl font-semibold mb-1">Daftar Akun Baru</h2>
    <p class="text-center text-gray-500 text-sm mb-6">Bergabung dengan perpustakaan kami</p>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($nama) || empty($email) || empty($password)) {
            ...
            if ($stmt->get_result()->num_rows > 0) {
                ...
                $stmt2 = $koneksi->prepare("INSERT INTO users (nama, email, password, role) VALUES (?, ?, ?, 'member')");
  ...
  <path d="M8 5a3 3 0 1 1 0 6A3 3 0 0 1 8 5z"/>
    ...
    <div class="mt-6 text-center">
      <p class="text-gray-600 text-sm">
        Sudah punya akun? <a href="login.php" class="text-red-900 font-medium hover:underline">Login</a>
      </p>
    </div>
